...
var ModuleType;
(function (ModuleType) {
    ModuleType[ModuleType["folder"] = Infinity] = "folder";
...
(function (System) {
    ...
    (function (basics) {
        var Url = (function () {
            function Url(url) {
                if (url)
                    this.init(url);
                this.setDefaultType(ModuleType.code);
            }
            ...
            Url.prototype.getUrl = function (url) {
                ...
                if (qi !== -1) {
                    this.params = url.substr(qi);
                    url = url.substr(0, qi);
                }
                return url;
            };
            Url.prototype.init = function (url) {
                url = this.getUrl(url.toLowerCase().trim());
    ...
    (function (core) {
        ...
        var Module = (function () {
            ...
            Module.prototype.require = function (modulePath, callback, onerror, context) {
                if (typeof modulePath == 'string') {
                    var toGet = this.GetModule(modulePath);
            ...
            Module.Init = function () {
                ...
                for (var i = 0; i < scrs.length; i++) {
                    ...
                    if (app != undefined) {
                        ...
                        root.require(url.toString(), function (o) { o.Start && o.Start(); }, function (o) { alert('we cannot find app'); });
                    }
                }
            };
            ...
            Module.prototype.GetModule = function (url) {
                ...
                return (url.IsPlugin ? this.Folder : this.FolderContext).GetModule(url);
            };
            Module.id = 0;
            return Module;
        }());
        ...
        var Folder = (function () {
            ...
            Folder.prototype.GetFolder = function (url) {
                var path = url.path;
                var f;
                if (url.IsExternal)
                    if (url.IsInternal)
            ...
            Folder.prototype.CreateModule = function (url) {
                var ressource = url.isAsset === true ? this.Assets : this.Modules;
                var module = ressource.getModule(url);
                if (module == null) {
            ...
            Folder.CreatePath = function (urlPath, cf) {
                for (var i = 0, l = urlPath.length; i < l; i++) {
                    var folderName = urlPath[i];
                    folderName = folderName.trim();
                    switch (folderName) {
            ...
            Folder.prototype.LoadAssembly = function (absolutePath, alias, callback) {
                ...
                if (assembly)
                    if (assembly.ResourceUrl.IsEquals(assemblyPath)) {
                        assembly.OnExecuted = function (assembly, e) { return callback && callback(assembly.EntryPoint.exports); };
                        return assembly;
                    }
                    else
                        throw "Assembly conflit";
                ...
                assembly.OnExecuted = function (assembly, e) {
            ...
            Folder.prototype.Replace = function (f, root) {
                if (!f)
                    if (!root)
...
//# sourceMappingURL=bin/QLoader.js.map