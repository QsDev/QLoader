...
declare var clone: (obj) => any;
declare var $: (selector, context) => void;
...
declare namespace System {
    ...
    namespace net {
        ...
        class EventListener {
            ...
            On: Function;
            Off: Function;
            private call(_this, array, curs, l);
...
declare module "json|*" {
    function require(path: string, callback: (e) => void, onError: () => void): any;
    var value: any;
}
declare module "html|*" {
    const value: any;
